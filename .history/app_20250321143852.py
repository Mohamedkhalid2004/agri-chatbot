...
# Function to set custom background and animations
...
if theme == "Dark":
    st.markdown("""
        <style>
            body { background-color: #1e1e1e; color: dark; }
            .stButton>button { background-color: #007BFF; color: dark; border-radius: 10px; }
        </style>
    """, unsafe_allow_html=True)
...
if st.button("🚀 Get Recommendations"):
    ...
    st.markdown(f"""
        <div class="info-box">
            ...
            <p style="font-size:22px;"><strong>{water_needed} mm</strong></p>
        </div>
        <div class="info-box">
            <h3>📅 Estimated Harvest Date:</h3>
            <p style="font-size:22px;"><strong>{harvest_date}</strong></p>
        </div>
        <div class="info-box">
            <h3>💬 our common advice:</h3>
            <p style="font-size:18px;">{gpt_response}</p>
        </div>
    """, unsafe_allow_html=True)
